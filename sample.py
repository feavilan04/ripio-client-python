...
# ripio.api_key = "U2FsdGVkX1+XtVrDRsxsAkMgY9zUpuLHDDVFegsTfAk8gzfLG99IYram7yVkcfIUjbndscjbdsjk"# noqa:E501
new_trade = Client()
...
print(
    new_trade.get_book_estimate_price(pair="BTC_BRL", amount="10", side="sell")
)
